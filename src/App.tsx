          ...
          {currentView === 'settings' && (
            <div className="flex-1 overflow-y-auto w-full bg-slate-50 dark:bg-slate-900">
              <div className="p-8 text-center text-slate-500 dark:text-slate-400">
                ...
                <div className="mt-8 w-full bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 text-left">
                ...
                {isAdmin && (
                  <div className="mt-6 w-full bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
