        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2 text-blue-600 dark:text-blue-500 font-bold text-xl">
              ...
              <span className="hidden sm:block">InfoConnect</span>
            </div>
            <div className="flex items-center gap-2 sm:gap-4">
              <button
                onClick={onNavigateToLogin}
                className="px-3 py-2 sm:px-4 sm:py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs sm:text-sm font-medium rounded-lg transition-all shadow-sm hover:shadow-md whitespace-nowrap"
              >
