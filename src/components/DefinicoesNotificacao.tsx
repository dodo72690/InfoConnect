...
const DefinicoesNotificacao: React.FC = () => {
    ...
    return (
        <div className="w-full mt-8">
            <h3 className="font-semibold mb-4 text-slate-800 dark:text-white flex items-center gap-2 text-left">
                <Bell size={18} className="text-blue-600" />
                Configuração de Notificações
            </h3>

            <div className="bg-white dark:bg-slate-800 p-4 md:p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm text-left">
...
export default DefinicoesNotificacao;
