...
import { X, Mail, Key, Loader2, CheckCircle, ArrowRight, Eye, EyeOff } from 'lucide-react';
...
const ModalRecuperarSenha: React.FC<ForgotPasswordModalProps> = ({ isOpen, onClose }) => {
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-10 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500"
