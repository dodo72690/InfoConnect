...
import { History, Search, Filter, Download, Info, CheckCircle, XCircle, FileText } from 'lucide-react';
...
const LogsSistema: React.FC<SystemLogsProps> = ({ logs }) => {
  ...
  const handleExportPDF = () => {
    ...
    // Title
    doc.setFontSize(18);
    doc.text('Logs do Sistema', 14, 22);
    ...
    const tableColumn = ["Data / Hora", "Tipo", "Ação", "Utilizador", "Detalhes"];
